...
typedef struct
{
    std::string cameraName = DEFAULT_CC_CAMERA_NAME;
...
bool computeCameraCalibration(CameraCalibration &cc, const std::string &filepath);
bool loadCameraCalibration(CameraCalibration &cc);
